 ...
 */
package com.keyholesoftware.plugins.windup.rules;
 ...
 */
public class CreateIssuesOnJavaFileSensor implements Sensor {
	...
	private static final double ARBITRARY_GAP = 2.0;
	  ...
	  public void describe(SensorDescriptor descriptor) {
	    ...
	    // optimization to disable execution of sensor if project does
	    // not contain Java files or if the rule is not activated
